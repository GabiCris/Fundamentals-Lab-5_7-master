...
from Repository.BooksRepoFile import BooksRepoFile
from Repository.ClientsRepoFile import ClientsRepoFile
from Repository.RentalsRepoFile import RentalsRepoFile
from Repository.BooksRepoPickle import BooksRepoFilePickle
from Repository.ClientsRepoPickle import ClientsRepoFilePicke
from Repository.RentalsRepoPickle import RentalsRepoFilePickle

settings = open ("settings.txt", "r+")
firstLine = settings.readline()
firstLine = firstLine.split("=")

if firstLine[1] == "inmemory\n":
    booksRepo = bookList()
    clientsRepo = clients()
...
elif firstLine[1] == "file\n":
    booksRepo = BooksRepoFile()
    clientsRepo = ClientsRepoFile()
    rentalsRepo = RentalsRepoFile()
elif firstLine[1] == "binary\n":
    booksRepo = BooksRepoFilePickle()
    clientsRepo = ClientsRepoFilePicke()
    rentalsRepo = RentalsRepoFilePickle()
